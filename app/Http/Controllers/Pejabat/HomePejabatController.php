...
class HomePejabatController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('dashboard.pejabat.home.index', compact(
            'tickets',
            'total_tiket',
            'tiket_belum',
            'tiket_masuk',
    ...
    public function indexAll(Request $request)
    {
        ...
        return view('dashboard.pejabat.home.indexAll', compact(
            'tickets',
            'total_tiket',
            'tiket_belum',
            'tiket_masuk',
    ...
    public function indexProblem(Request $request)
    {
        ...
        return view('dashboard.pejabat.home.indexProblem', compact(
            'chartData',
            'tableData',
            'provinces',
            'categories',
