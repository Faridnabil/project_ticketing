...
class TicketSiakDevController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('dashboard.siak-dev.ticket.index', compact('tickets', 'categories', 'priorities', 'statuses'));
    }
    ...
    public function show($id)
    {
        ...
        return view(
            'dashboard.siak-dev.ticket.show',
            compact(
                'ticket',
                'logs',
                'priorities',
    ...
    public function destroy(Ticket $ticket)
    {
        try {
            ...
            return redirect()->route('siakDev.ticket.index')->with('success', 'Tiket Berhasil dihapus');
        } catch (\Throwable $th) {
            // Log activity
