...
class UserHelpdeskController extends Controller
{
    ...
    public function index(Request $request)
    {
        ...
        return view('dashboard.helpdesk.user-management.user.index', [
            'users' => $users,
        ]);
    }
    ...
    public function create(Request $request)
    {
        ...
        return view('dashboard.helpdesk.user-management.user.create', compact('roles'));
    }
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            return redirect()->route('helpdesk.user.index')->with('success', 'User created successfully');
        } catch (\Throwable $th) {
            DB::rollBack();
    ...
    public function edit($id)
    {
        ...
        return view('dashboard.helpdesk.user-management.user.edit', compact('user', 'roles', 'userRole'));
    }
    ...
    public function update(Request $request, User $user)
    {
        ...
        try {
            ...
            return redirect()->route('helpdesk.user.index')->with('success', 'User updated successfully');
        } catch (\Throwable $th) {
            DB::rollBack();
            return back()->with(['error' => 'Data gagal disimpan.'])->withInput();
        }
    ...
    public function destroy(User $user)
    {
        try {
            ...
            return redirect()->route('helpdesk/user')->with('success', 'user deleted successfully');
        } catch (\Throwable $th) {
            // Log activity
