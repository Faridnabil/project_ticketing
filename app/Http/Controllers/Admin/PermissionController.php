...
class PermissionController extends Controller
{
    public function index(Request $request)
    {
        ...
        return view('dashboard.admin.user-management.permission.index', compact('permissions'));
    }

    public function create()
    {
        $permission = Permission::pluck('name', 'name')->all();
        return view('dashboard.admin.user-management.permission.create', compact('permission'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('dashboard.admin.user-management.permission.edit', compact('permission'));
    }
