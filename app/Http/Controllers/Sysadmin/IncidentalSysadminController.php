...
class IncidentalSysadminController extends Controller
{
    ...
    public function create()
    {
        $statuses = Status::all();
        $categories = IncidentalActivityCategory::all();
        return view('dashboard.sysadmin.incidental-activities.create', compact('statuses', 'categories'));
    }
    ...
    public function edit($id)
    {
        ...
        $statuses = Status::all();
        $categories = IncidentalActivityCategory::all();
        return view('dashboard.sysadmin.incidental-activities.edit', compact('activity', 'statuses', 'categories'));
    }
