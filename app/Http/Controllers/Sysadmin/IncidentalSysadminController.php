...
class IncidentalSysadminController extends Controller
{
    public function index()
    {
        ...
        // Kirim data ke view
        return view('dashboard.sysadmin.incidental-activities.index', compact('activities', 'statuses', 'categories'));
    }
    ...
    public function create()
    {
        ...
        return view('dashboard.sysadmin.incidental-activities.create', compact('statuses', 'categories', 'users', 'selectedUsers'));
    }
    ...
    public function edit($id)
    {
        ...
        return view('dashboard.sysadmin.incidental-activities.edit', compact('activity', 'statuses', 'categories', 'users', 'selectedUsers'));
    }
    ...
    public function destroy($id)
    {
        ...
        return redirect()->route('sysadmin.incidental-activities.index')
