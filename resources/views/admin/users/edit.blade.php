    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-place="true" data-kt-place-mode="prepend"
            ...
            <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Dashboard
                ...
                <!--end::Separator-->
                <!--begin::Description-->
                <small class="text-muted fs-7 fw-bold my-1 ms-1">   {{ trans('global.edit') }} {{ trans('cruds.user.title_singular') }}
                </small>
                <!--end::Description-->
            </h1>
            <!--end::Title-->
                                ...
                                <div class="card-body">
                                    <form action="{{ route('admin.users.update', [$user->id]) }}" method="POST" enctype="multipart/form-data">
                                        ...
                                        <div class="form-group {{ $errors->has('email') ? 'has-error' : '' }}">
                                            <label for="email" class="fs-5 fw-bold mb-2">{{ trans('cruds.user.fields.email') }}*</label>
                                        ...
                                        <div class="form-group {{ $errors->has('password') ? 'has-error' : '' }}">
                                            <label for="password" class="fs-5 fw-bold mb-2">{{ trans('cruds.user.fields.password') }}</label>
