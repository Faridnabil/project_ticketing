    ...
    <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
        ...
        <div data-kt-place="true" data-kt-place-mode="prepend"
            ...
            <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Menu
                ...
                <!--end::Separator-->
                <!--begin::Description-->
                <small class="text-muted fs-7 fw-bold my-1 ms-1">   {{ trans('global.create') }} {{ trans('cruds.category.title_singular') }}</small>
                <!--end::Description-->
            </h1>
            <!--end::Title-->
        </div>
                                    ...
                                    <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                                        ...
                                        @can('category_create')
                                            <a href="{{ route('admin.categories.create') }}" class="btn btn-sm btn-light-primary">
                                                ...
                                                <!--end::Svg Icon--> {{ trans('global.add') }} {{ trans('cruds.category.title_singular') }}</a>
                                        @endcan
                                    </div>
                                </div>
                                <!--end::Header-->
