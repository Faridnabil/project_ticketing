    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            ...
            <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                ...
                @can('category_create')
                    <a href="{{ route('admin.categories.create') }}" class="btn btn-sm btn-light-primary" data-bs-toggle="modal"
                        ...
                        <!--end::Svg Icon--> {{ trans('global.add') }} {{ trans('cruds.category.title_singular') }}
                    </a>
                @endcan
            </div>
        </div>
