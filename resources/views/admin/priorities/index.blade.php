    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            ...
            <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                title="Click to add a priority">
                @can('priority_create')
                    <a href="{{ route('admin.priorities.create') }}" class="btn btn-sm btn-light-primary" data-bs-toggle="modal"
                        ...
                        <!--end::Svg Icon--> {{ trans('global.add') }} {{ trans('cruds.priority.title_singular') }}
                    </a>
                @endcan
            </div>
        </div>
