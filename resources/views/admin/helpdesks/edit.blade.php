                        ...
                        <div id="kt_content_container" class="container">
                            ...
                            <div class="card">
                                ...
                                <div class="card-body p-lg-17">
                                    ...
                                    <div class="row mb-3">
                                        <!--begin::Col-->
                                        <form action="{{ route('admin.helpdesks.update', [$helpdesk->id]) }}" method="POST"
                                            ...
                                            <div class="form-group {{ $errors->has('priority_id') ? 'has-error' : '' }}">
                                                ...
                                                <select name="priority_id" id="priority_id"  class="form-select" data-control="select2">
                                                    @foreach ($priorities as $id => $priority)
                                                        <option value="{{ $id }}"
                                                            {{ (isset($helpdesk) && $helpdesk->priorities ? $helpdesk->priorities->name : old('priority_id')) == $id ? 'selected' : '' }}>
                                                            {{ $priority }}</option>
                                                    @endforeach
                                                </select>
                                        ...
                                        <select name="category_id" id="category_id"  class="form-select" data-control="select2">
                                            @foreach ($categories as $id => $category)
                                                <option value="{{ $id }}" {{ (isset($helpdesk) && $helpdesk->categories ? $helpdesk->categories->name : old('category_id')) == $id ? 'selected' : '' }}>{{ $category }}</option>
                                            @endforeach
                                        </select>
                                        @if ($errors->has('priority_id'))
                                            <em class="invalid-feedback">
                                        ...
                                        @endif
                                            ...
                                            <div class="form-group {{ $errors->has('status_id') ? 'has-error' : '' }}">
                                                ...
                                                <select name="status_id" id="user"  class="form-select" data-control="select2">
