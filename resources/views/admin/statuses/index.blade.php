        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend"
                ...
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Menu
                    ...
                    <!--end::Separator-->
                    <!--begin::Description-->
                    <small class="text-muted fs-7 fw-bold my-1 ms-1">Status</small>
                    <!--end::Description-->
                </h1>
                <!--end::Title-->
            </div>
    ...
    <div class="card mb-5 mb-xl-8">
        ...
        <div class="card-header border-0 pt-5">
            ...
            <div class="card-toolbar" data-bs-toggle="tooltip" data-bs-placement="top" data-bs-trigger="hover"
                title="Click to add a status">
                @can('status_create')
                    <a href="{{ route('admin.statuses.create') }}" class="btn btn-sm btn-light-primary" data-bs-toggle="modal"
                        ...
                        <!--end::Svg Icon--> {{ trans('global.add') }} {{ trans('cruds.status.title_singular') }}
                    </a>
                @endcan
            </div>
        </div>
...
@section('scripts')
    ...
    <script>
        $(function() {
            ...
            $('.datatable-Status:not(.ajaxTable)').DataTable({
                buttons: dtButtons
            })
