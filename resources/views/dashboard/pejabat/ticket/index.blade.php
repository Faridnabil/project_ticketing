            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        <!--begin::Form-->
                        <form method="GET" action="{{ route('pejabat.ticket.index') }}" id="filterForm" class="d-flex align-items-center gap-2">
    ...
    @foreach ($tickets as $ticket)
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="{{ route('pejabat.ticket.destroy', $ticket->id) }}" method="POST"
                            class="d-inline">
                            @method('delete')
                            @csrf
        ...
        <div class="modal fade" tabindex="-1" id="kt_modal_ticket2_{{ $ticket->id }}">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('pejabat.tickets.send', $ticket->id) }}" method="POST" class="d-inline">
                        @method('PUT')
                        @csrf
                        <div class="modal-body">
                            <div class="row">
        ...
        <script>
            ...
            document.getElementById('statusSelect_{{ $ticket->id }}').addEventListener('change', function() {
                ...
                window.location.href = "{{ route('pejabat.tickets.confirm', $ticket->id) }}";
                return;
            }
