                            ...
                            @if ($tickets->count())
                                @foreach ($tickets as $ticket)
                                    ...
                                    <tr>
                                        ...
                                        <!--begin::Assign To=-->
                                        <td>
                                            @if ($ticket->level5 != null)
                                                @foreach ($ticket->pejabat->getRoleNames() as $role)
                                                    {{ $role }}
                                                @endforeach
                                            @else
                                                <span class="badge"
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('pejabat.tickets.statusTicket', $ticket->id) }}"
        ...
        <div class="modal fade" tabindex="-1" id="kt_modal_ticket2_{{ $ticket->id }}">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('pejabat.ticket.update_approval', $ticket->id) }}" method="POST" class="d-inline">
                        @method('put')
                        @csrf
                        <div class="modal-body">
                            <div class="row">
