                                            ...
                                            <div class="col"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div style="margin-left: 15px;margin-top:7px">
                                                        <a href="{{ route('pejabat.ticket.index',array_merge(request()->query(), ['status_id' => 2, 'TicketDiterima' => $tiket_masuk])) }}"
                                            ...
                                            <div class="col"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div style="margin-left: 2px;margin-top:7px">
                                                        <a href="{{ route('pejabat.ticket.index',array_merge(request()->query(), ['status_id' => 3, 'TicketProses' => $tiket_proses])) }}"
                                            ...
                                            <div class="col"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div style="margin-left: 10px">
                                                        <a href="{{ route('pejabat.ticket.index', array_merge(request()->query(), ['status_id' => 4, 'TicketSelesai' => $tiket_selesai])) }}"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function updateCharts(year, month) {
                let urlDaily = `/pejabat/tickets/dailyChart`;
                let urlYearly = `/pejabat/tickets/chart`;
