                            ...
                            <template id="materialize-template">
                                <div>
                                    ...
                                    <div class="card card-xxl-stretch mt-3 mb-4" style="border-radius: 10px">
                                        ...
                                        <!-- Filter Form -->
                                        <form method="get" action="{{ route('staffSubdit.dashboard.index') }}">
                                            <div class="row" style="margin-left:20px">
                                                ...
                                                <div class="input-field col s1" style="margin-top: 28px">
                                                    <button type="submit" class="btn waves-effect waves-light"
                                                        id="submitFilter"
                                                        style="background-color: #19bb52;border-radius:5px;text-transform: capitalize "><b>Filter
                                                            Data</b></button>
                                                </div>
                                                <div class="input-field col s1" style="margin-top: 28px">
                                                    <a href="{{ route('helpdesk.dashboard.index') }}"
                                                        class="btn waves-effect waves-light"
                                                        style="background-color: #009EF7;border-radius:5px; text-transform: capitalize"><b>Penyegaran</b></a>
                                                </div>
                                            </div>
                                        </form>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function fetchAndRenderChart(selectedDate, startTime, endTime) {
                fetch(
                        `{{ route('staffSubdit.tickets.todaydailychart') }}?selectedDate=${encodeURIComponent(selectedDate)}&startTime=${encodeURIComponent(startTime)}&endTime=${encodeURIComponent(endTime)}`
                    )
