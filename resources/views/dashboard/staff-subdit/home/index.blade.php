                            ...
                            <div class="card-p mt-n20 position-relative">
                                ...
                                <div class="row g-0">
                                    <div class="col"
                                        ...
                                        <a href="{{ route('staffSubdit.ticket.index', ['filter' => 'Diterima']) }}" class="text-danger fw-bold fs-6">Tiket Masuk</a>
                                    </div>
                                    ...
                                    <div class="col"
                                        ...
                                        <a href="{{ route('staffSubdit.ticket.index', ['filter' => 'Proses']) }}" class="text-warning fw-bold fs-6">Tiket Dalam Proses</a>
                                    </div>
                                    ...
                                    <div class="col"
                                        ...
                                        <a href="{{ route('staffSubdit.ticket.index', ['filter' => 'Tertunda']) }}" class="text-info fw-bold fs-6">Tiket Pending</a>
                                    </div>
                                    ...
                                    <div class="col"
                                        ...
                                        <a href="{{ route('staffSubdit.ticket.index', ['filter' => 'Selesai']) }}" class="text-success fw-bold fs-6">Tiket Selesai</a>
                                    </div>
                                    ...
                                    <div class="col"
                                        ...
                                        <a href="{{ route('staffSubdit.ticket.index') }}" class="text-primary fw-bold fs-6">Total Tiket</a>
                                    </div>
                                </div>
