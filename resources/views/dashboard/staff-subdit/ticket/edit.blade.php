                ...
                <div class="col-xl-12">
                    <div class="card card-xl-stretch mb-xl-8">
                        <div class="card-body pt-5">
                            ...
                            action="{{ route('staffSubdit.ticket.update', $ticket->id) }}" enctype="multipart/form-data" novalidate>
                            @csrf
                            @method('PUT')
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="category_id" class="form-select @error('category_id') is-invalid @enderror" data-control="select2" data-placeholder="Pilih Kategori" required autofocus>
                                    <option></option>
                            ...
                            <div class="col-md-3">
                                ...
                                <select id="province_id" data-control="select2" name="province_id" class="form-select @error('province_id') is-invalid @enderror" required>
                                    <option value="" selected disabled>Pilih Provinsi</option>
                                    @foreach ($provinces as $province)
                                        <option value="{{ $province->id }}" {{ $ticket->province_id == $province->id ? 'selected' : '' }}>
                            ...
                            <div class="col-md-3">
                                ...
                                <select id="city_or_regency_id" data-control="select2" name="city_or_regency_id" class="form-select @error('city_or_regency_id') is-invalid @enderror" required>
                                    <option value="" selected disabled>Pilih Kabupaten/Kota</option>
                                    @foreach ($city_or_regencies as $city)
                                        <option value="{{ $city->id }}" {{ $ticket->city_or_regency_id == $city->id ? 'selected' : '' }}>
                                            {{ $city->province->no_province }} - {{ $city->city_or_regency_name }}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="status_id" class="form-select @error('status_id') is-invalid @enderror" data-control="select2" data-placeholder="Pilih Status" required autofocus>
                                    <option></option>
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="pic" class="form-control @error('pic') is-invalid @enderror" id="pic" placeholder="Masukan PIC" value="{{ old('pic', $ticket->pic) }}">
                            ...
                            <div class="col-md-3">
                                ...
                                <input type="text" name="jabatan" class="form-control @error('jabatan') is-invalid @enderror" id="jabatan" placeholder="Masukan jabatan" value="{{ old('jabatan', $ticket->jabatan) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <select name="priority_id" class="form-select @error('priority_id') is-invalid @enderror" data-control="select2" data-placeholder="Pilih Prioritas" required autofocus>
                                    <option></option>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="text" name="no_hp" class="form-control @error('no_hp') is-invalid @enderror" id="no_hp" placeholder="Masukan Nomor Handphone/WA" value="{{ old('no_hp', $ticket->no_hp) }}">
                            ...
                            <div class="col-md-6">
                                ...
                                <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="description" cols="10" rows="3">{{ old('description', $ticket->description) }}</textarea>
                                <div class="valid-feedback">Looks good!</div>
                                @error('description')
                                    <div class="invalid-feedback">{{ $message }}</div>
                                @enderror
                            ...
                            <div class="col-12">
                                ...
                                <a href="{{ route('staffSubdit.ticket.index') }}" class="btn btn-danger">Cancel</a>
                            </div>
                        </form>
