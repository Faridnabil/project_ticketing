            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        <!--begin::Form-->
                        <form method="GET" action="{{ route('staffSubdit.ticket.index') }}" class="d-flex">
                            ...
                            <a href="{{ route('staffSubdit.ticket.index') }}" class="btn btn-danger">Reset</a>
                        </form>
                        <!--end::Form-->
                    </div>
                </div>
                            ...
                            @if ($tickets->count())
                                @foreach ($tickets as $ticket)
                                    ...
                                    <tr>
                                        ...
                                        <!--begin::Assign To=-->
                                        <td>
                                            @if ($ticket->level3 != null)
                                                @foreach ($ticket->staffSubdit->getRoleNames() as $role)
                                                    {{ $role }}
                                                @endforeach
                                            @else
                                                <span class="badge"
                                        ...
                                        <td>
                                            ...
                                            <form action="{{ route('staffSubdit.tickets.statusTicket', $ticket->id) }}"
        ...
        <div class="modal fade" tabindex="-1" id="kt_modal_ticket2_{{ $ticket->id }}">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="{{ route('staffSubdit.ticket.update_approval', $ticket->id) }}" method="POST" class="d-inline">
                        @method('put')
                        @csrf
                        <div class="modal-body">
                            <div class="row">
