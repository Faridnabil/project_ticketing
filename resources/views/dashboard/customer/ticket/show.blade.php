            ...
            <div class="card-body">
                ...
                <div class="tab-content">
                    ...
                    <div class="tab-pane fade show active" id="keluhan" role="tabpanel">
                        ...
                        <div class="col-xl-5">
                            <!--begin::Messenger-->
                            <div class="card" id="kt_chat_messenger" style="box-shadow: 0 4px 8px rgba(0, 0, 0, 0.3);">
                                <!--begin::Card header-->
                                            ...
                                            <div class="d-flex justify-content-{{ $comment->user_id == auth()->user()->id ? 'end' : 'start' }} mb-10"
                                                ...
                                                <div
                                                    ...
                                                    <div class="p-5 rounded bg-light-{{ $comment->user_id == auth()->user()->id ? 'primary' : 'info' }} text-dark fw-bold mw-lg-400px text-{{ $comment->user_id == auth()->user()->id ? 'end' : 'start' }}"
                                                        ...
                                                        <form action="{{ route('myTickets.update', $comment->id) }}" method="POST"
                                                            class="comment-form" data-comment-id="{{ $comment->id }}">
                                                            @method('PUT')
                                                            @csrf
                                ...
                                <div class="card-footer pt-4" id="kt_chat_messenger_footer">
                                    <form class="row g-3 mt-2 needs-validation" method="POST"
                                        action="{{ route('myTickets.store') }}" enctype="multipart/form-data" novalidate>
                                        @csrf
