                                    ...
                                    <form class="row g-3 needs-validation" method="POST"
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <select name="customer"
                                                class="form-control @error('customer') is-invalid @enderror" required
                                                autofocus style="pointer-events: none">
                                                <option value="" disabled>Pilih Pemilik</option>
                                                @foreach ($users_s as $user)
                                        ...
                                        <div class="col-md-6">
                                            ...
                                            <div class="custom-dropzone"
                                                ...
                                                <div class="dz-message">
                                                    <h3 class="fs-5 fw-bolder text-gray-900 mb-1 mt-5">Letakkan file di
                                                        sini atau
                                        ...
                                        <div class="col-12">
                                            ...
                                            <a href="{{ route('assignedSysadmin.index') }}"
