...
@section('content')
            ...
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex align-items-center">
                        @can('Create Service')
                            <a href="{{ route('service.create') }}" class="btn btn-primary btn-sm me-2">
                                    ...
                                    @foreach ($services as $service)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                ...
                                                @endcan
                                                @can('Delete Service')
                                                    <a class="menu-link ms-3" href="#" type="reset" data-bs-toggle="modal" data-bs-target="#kt_modal_service_{{ $service->id }}">
    ...
    @foreach ($services as $service)
        <div class="modal fade" tabindex="-1" id="kt_modal_service_{{ $service->id }}">
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-lg-9">
                                <h5>Apakah Anda yakin menghapus layanan ini?</h5>
