                ...
                <div class="col-xxl-12 ">
                    ...
                    <div class="Header" style="margin-bottom: 25px; padding-left: 5px;">
                        <ul class="nav custom-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="btn-custom font-regular {{ request()->routeIs('admin.dashboard.index') ? 'active' : '' }}"
                            ...
                            <li class="nav-item">
                                <a class="btn-custom font-regular {{ request()->routeIs('admin.dashboard.indexProblem') ? 'active' : '' }}"
                                    href="{{ route('admin.dashboard.indexProblem') }}">
                                            ...
                                            <div class="col"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div style="margin-left: 15px;margin-top:7px">
                                                        <a href="{{ route('admin.ticket.index', array_merge(request()->query(), ['status_id' => 2, 'TicketDiterima' => $tiket_masuk])) }}"
                                            ...
                                            <div class="col"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div style="margin-left: 2px;margin-top:7px">
                                                        <a href="{{ route('admin.ticket.index', array_merge(request()->query(), ['status_id' => 3, 'TicketProses' => $tiket_proses])) }}"
                                            ...
                                            <div class="col"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div style="margin-left: 10px">
                                                        <a href="{{ route('admin.ticket.index', array_merge(request()->query(), ['status_id' => 4, 'TicketSelesai' => $tiket_selesai])) }}"
