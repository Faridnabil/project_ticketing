                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            ...
                            <div class="d-flex justify-content-end" data-kt-customer-table-toolbar="base">
                                ...
                                <!--begin::Add user-->
                                <a href="{{ route('province.exportFormat') }}" class="btn mb-4" style="background-color: #ee8d18;color:white">
                                ...
                                <a href="" class="btn btn-danger mb-4" data-bs-toggle="modal"
                                ...
                                <a href="{{ route('province.export') }}" class="btn mb-4" style="background-color: #17ba4b;color:white">
                                    <span class="img-icon">
        ...
        <div class="modal-dialog modal-dialog-centered mw-650px">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body scroll-y mx-5 mx-xl-15 my-7">
                    <!--begin::Form-->
                    <form class="row g-3 needs-validation" method="POST" action="{{ route('province.import') }}"
