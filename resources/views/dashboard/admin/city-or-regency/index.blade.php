                        ...
                        @can('Create City Or Regency')
                            <div class="card-toolbar">
                                ...
                                <a href="{{ route('cityOrRegency.create') }}" class="btn btn-primary mb-4">
                                    ...
                                    <!--end::Svg Icon-->Tambah Kota/Kabupaten</a>
                                <!--end::Add user-->
                            </div>
                        @endcan
                        <!--end::Card toolbar-->
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                @can('Edit City Or Regency')
                                                    <a class="menu-link ms-3" href="{{ route('cityOrRegency.edit', $cityOrRegency->id) }}"
                                                        type="button">
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="{{ route('cityOrRegency.destroy', $cityOrRegency->id) }}" method="POST" class="d-inline">
                            @method('delete')
                            @csrf
