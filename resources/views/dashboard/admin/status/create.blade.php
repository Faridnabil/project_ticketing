...
@section('content')
    ...
    <div class="post d-flex flex-column-fluid" id="kt_post">
        <div id="kt_content_container" class="container">
            <a href="{{ route('status.index') }}" class="btn btn-custom">
                    ...
                    <div class="row g-5 g-xl-12">
                        <div class="col-xl-12">
                            ...
                            <div class="card-body pt-5">
                                <form class="row g-3 needs-validation" method="POST" action="{{ route('status.store') }}"
                                    ...
                                    <div class="col-md-12">
                                        ...
                                        <input type="text"
                                            ...
                                            name="status_name" autofocus required>
