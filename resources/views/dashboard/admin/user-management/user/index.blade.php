                    ...
                    <table id="kt_datatable_example_5" class="table table-striped table-row-bordered gy-5 gs-7 border rounded">
                        ...
                        <tbody class="text-gray-600 fw-bold">
                            ...
                            <tr class="fs-6 w-100">
                                    ...
                                    <div class="symbol symbol-circle symbol-50px overflow-hidden me-3">
                                        <a href="apps/user-management/users/view.html">
                                            <div class="symbol-label">
                                                @if ($user->gender == 'Pria')
                                                <img src="{{ asset($user->photo ? $user->photo : 'template/dist/assets/media/avatars/blank.png') }}" class="w-100" />
                                                @else
                                                <img src="{{ asset($user->photo ? $user->photo : 'template/dist/assets/media/avatars/blank.png') }}" class="w-100" />
                                                @endif
                                            </div>
                                ...
                                @else
                                <td>
                                    <span class="badge mt-4" style="background-color:rgb(77, 75, 75) ; color: white; font-weight:bold w-100 mt-3 p-3">
                                        -
                                    </span>
                                </td>
                                @endif
                                ...
                                <td>
                                    @can('Edit User')
                                    <a class="menu-link ms-3" href="{{ route('user.edit', $user->id) }}" type="button" title="Edit">
                                    ...
                                    @endcan
                                    @can('Delete User')
                                    <a class="menu-link ms-3" href="#" type="reset" title="Hapus" data-bs-toggle="modal" data-bs-target="#kt_modal_1{{ $user->id }}">
            ...
            <div class="modal-body">
                <div class="row">
                    <div class="col-lg-3 text-center align-self-center">
                        <img src="{{ asset($user->photo ? $user->photo : 'template/assets/images/users/user-1.png') }}" alt="" class="img-fluid">
                    </div><!--end col-->
                    <div class="col-lg-9">
