    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Role
                    <!--begin::Separator-->
                    <span class="h-20px border-gray-200 border-start ms-3 mx-2"></span>
                    <!--end::Separator-->
                    <!--begin::Description-->
                    <small class="text-muted fs-7 fw-bold my-1 ms-1">Data Role</small>
                    <!--end::Description-->
                </h1>
                <!--end::Title-->
            </div>
                ...
                <div class="card">
                    <div class="card-header card-header d-flex justify-content-between align-items-center">
                        ...
                        <div class="d-flex align-items-center">
                            @can('Create Role')
                                <a href="{{ route('role.create') }}" class="btn btn-primary btn-sm me-2">
                                                ...
                                                <td>
                                                    ...
                                                    @can('Delete Role')
                                                        <a class="menu-link ms-3" href="#" type="reset"
                                                            ...
                                                            data-bs-target="#kt_modal_1{{ $role->id }}">
