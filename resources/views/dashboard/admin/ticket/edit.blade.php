                ...
                <div class="col-xl-12">
                    ...
                    <div class="card card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body pt-5">
                            <form class="row g-3 needs-validation" method="POST" action="{{ route('ticket.update', $ticket->id) }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="customer" class="form-control @error('customer') is-invalid @enderror"
                                        ...
                                        @foreach ($customers as $customer)
                                            <option value="{{ $customer->id }}" {{ $ticket->customer == $customer->id ? 'selected' : '' }}>{{ $customer->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="assign_to" class="form-control @error('assign_to') is-invalid @enderror"
                                        ...
                                        @foreach ($assignTo as $assign)
                                            <option value="{{ $assign->id }}" {{ $ticket->assign_to == $assign->id ? 'selected' : '' }}>{{ $assign->name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="priority_id"
                                        ...
                                        @foreach ($priorities as $priority)
                                            <option value="{{ $priority->id }}" {{ $ticket->priority_id == $priority->id ? 'selected' : '' }}>{{ $priority->priority_name }}</option>
                                        @endforeach
                                    </select>
                                ...
                                <div class="col-md-6">
                                    ...
                                    <input type="date" name="due_date" class="form-control" value="{{ old('due_date', $ticket->due_date) }}">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <textarea name="description" class="form-control @error('description') is-invalid @enderror" id="description"
                                        cols="10" rows="10">{{ old('description', $ticket->description) }}</textarea>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="image-input image-input-outline" data-kt-image-input="true" style="background-image: url({{ asset($ticket->attachment) }})">
                                        <div class="image-input-wrapper w-125px h-125px" style="background-image: url({{ asset($ticket->attachment) }});"></div>
