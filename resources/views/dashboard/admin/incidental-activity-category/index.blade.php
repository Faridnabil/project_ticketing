...
@section('title')
    Kategori Incidental Activity | PLN Icon+
@endsection
    ...
    <div class="toolbar" id="kt_toolbar">
        ...
        <div id="kt_toolbar_container" class="container-fluid d-flex flex-stack">
            ...
            <div data-kt-place="true" data-kt-place-mode="prepend"
                ...
                <!--begin::Title-->
                <h1 class="d-flex align-items-center text-dark fw-bolder my-1 fs-3">Kategori Incidental Activity
                    <!--begin::Separator-->
        ...
        <div id="kt_content_container" class="container">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    <h4 class="card-title">Tabel Kategori Incidental Activity</h4>
                    <div class="d-flex align-items-center">
                        @can('Create Category')
                            <a href="{{ route('incidental-activity-category.create') }}" class="btn btn-primary btn-sm me-2">
                                ...
                                @if ($categories->count())
                                    @foreach ($categories as $category)
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                @can('Edit Category')
                                                    <a class="menu-link ms-3" href="{{ route('incidental-activity-category.edit', $category->id) }}"
                                                        type="button">
                ...
                <div class="modal-content">
                    <div class="modal-header bg-danger">
                        <h6 class="modal-title m-0 text-white" id="exampleModalDanger1">
                            Form Hapus Kategori Incidental Activity
                        </h6>
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="{{ route('incidental-activity-category.destroy', $category->id) }}" method="POST" class="d-inline">
                            @method('delete')
                            @csrf
