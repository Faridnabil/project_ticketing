...
@section('content')
                    ...
                    <div class="card card-xxl-stretch" style="height: 190px">
                        ...
                        <div class="card-body p-0">
                            ...
                            <div class="card-p mt-n20 position-relative">
                                ...
                                <div class="row g-0">
                                    <div class="col"
                                        style="width: 20%; background-color: #f8d7da; padding: 1rem; border-radius: 0.5rem;">
                                        ...
                                        <span class="text-danger fw-bold fs-3">{{ $tiket_masuk }}</span>
                                        <a href="{{ route('koordinator.ticket.index', ['filter' => 'Diterima']) }}" class="text-danger fw-bold fs-6">Tiket Masuk</a>
                                    </div>
                                    ...
                                    <div class="col"
                                        ...
                                        <a href="{{ route('koordinator.ticket.index', ['filter' => 'Proses']) }}" class="text-warning fw-bold fs-6">Tiket Dalam Proses</a>
                                    </div>

                                    <div class="col"
                                        style="width: 20%; background-color: #d1ecf1; padding: 1rem; border-radius: 0.5rem; margin-bottom: 1.75rem;">
                                        <span class="svg-icon svg-icon-3x svg-icon-info d-block my-1 mb-3">
                                            <!-- SVG Icon -->
                                        ...
                                        <span class="text-info fw-bold fs-3">{{ $tiket_tertunda }}</span>
                                        <a href="{{ route('koordinator.ticket.index', ['filter' => 'Tertunda']) }}" class="text-info fw-bold fs-6">Tiket Pending</a>
                                    </div>
                                    ...
                                    <div class="col"
                                        ...
                                        <a href="{{ route('koordinator.ticket.index', ['filter' => 'Selesai']) }}" class="text-success fw-bold fs-6">Tiket Selesai</a>
                                    </div>
                                    ...
                                    <div class="col"
                                        ...
                                        <a href="{{ route('koordinator.ticket.index') }}" class="text-primary fw-bold fs-6">Total Tiket</a>
                                    </div>
                                </div>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            fetch('{{ url('/koordinator/tickets/dailyChart') }}')
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            fetch('{{ url('/koordinator/tickets/chart') }}')
                .then(response => response.json())
                .then(data => {
