                                            ...
                                            <div class="col"
                                                ...
                                                <div class="d-flex align-items-center">
                                                    ...
                                                    <div style="margin-left: 10px">
                                                        <a href="{{ route('koordinator.ticket.index', array_merge(request()->query(), ['status_id' => 4, 'TicketSelesai' => $tiket_selesai])) }}"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function updateCharts(year, month) {
                let urlDaily = `/koordinator/tickets/dailyChart`;
                let urlYearly = `/koordinator/tickets/chart`;
