                ...
                <div class="col-xl-12">
                    <div class="card card-xl-stretch mb-xl-8">
                        <div class="card-body pt-5">
                            ...
                            action="{{ route('koordinator.ticket.update', $ticket->id) }}" enctype="multipart/form-data" novalidate>
                            @csrf
                            @method('PUT')
                            ...
                            <div class="col-12">
                                ...
                                <a href="{{ route('koordinator.ticket.index') }}" class="btn btn-danger">Batal</a>
                            </div>
                        </form>
