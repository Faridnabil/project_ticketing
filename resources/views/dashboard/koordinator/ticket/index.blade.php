            ...
            <div class="card">
                ...
                <div class="card-header border-0 pt-6">
                    ...
                    <div class="card-title">
                        <!--begin::Form-->
                        <form method="GET" action="{{ route('koordinator.ticket.index') }}" id="filterForm" class="d-flex align-items-center gap-2">
                                        ...
                                        <td>
                                            <div class="d-flex align-items-center">
                                                ...
                                                @if (($ticket->status && $ticket->status_id == '2') || $ticket->status_id == '3' || $ticket->status_id == '5')
                                                    <form
                                                        action="{{ route('koordinator.tickets.statusTicket', $ticket->id) }}"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    <div class="modal-header bg-primary">
                        <h6 class="modal-title m-0 text-white" id="exampleModalDanger1">
                            Form Pengalihan Tiket Ke Staff Subdit
                        </h6>
                        <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                    </div><!--end modal-header-->
                    <form action="{{ route('koordinator.tickets.send', $ticket->id) }}" method="POST" class="d-inline">
                        @method('PUT')
                        @csrf
                        <div class="modal-body">
                            <div class="row">
                                <div class="col-lg-12">
                                    <h5>Apakah Anda yakin tugas Tiket ini dialihkan kepada Staff Subdit?</h5>
                                    <small
                                        class="text-muted ml-2">{{ date('d F Y', strtotime(Carbon\Carbon::now())) }}</small>
                                    <br><br>
                                    <style>
                                    ...
                                    <select name="level3" hidden required>
                                        @foreach ($StaffSubditkRoles as $roleId)
