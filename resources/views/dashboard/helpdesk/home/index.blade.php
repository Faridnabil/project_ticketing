                ...
                <div class="col-xxl-12 ">
                    ...
                    <div class="Header" style="margin-bottom: 30px">
                        <ul class="nav custom-tabs" role="tablist">
                            <li class="nav-item">
                                <a class="btn-custom font-regular mt-4" data-bs-toggle="tab" href="#harian"
                                    role="tab" aria-selected="true" data-tab="harian">
                                    <strong>Data Harian ini</strong>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a class="btn-custom font-regular" data-bs-toggle="tab" href="#keseluruhan"
                                    role="tab" aria-selected="false" data-tab="keseluruhan">
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function fetchDailyData() {
                ...
                fetch(`{{ url('/helpdesk/tickets/todaydailychart') }}?year=${year}&month=${month}`)
                    .then(response => {
                        if (!response.ok) {
