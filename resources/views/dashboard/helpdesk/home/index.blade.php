                                                ...
                                                <div class="col"
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div style="margin-left: 15px;margin-top:7px">
                                                            <a href="{{ route('helpdesk.ticket.index', array_merge(request()->query(), ['status_id' => 2, 'TicketDiterima' => $tiket_masuk, 'year' => now()->year, 'month' => now()->format('m')])) }}"
                                                ...
                                                <div class="col"
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div style="margin-left: 2px;margin-top:7px">
                                                            <a href="{{ route('helpdesk.ticket.index', array_merge(request()->query(), ['status_id' => 3, 'TicketProses' => $tiket_proses, 'year' => now()->year, 'month' => now()->format('m')])) }}"
                                                ...
                                                <div class="col"
                                                    ...
                                                    <div class="d-flex align-items-center">
                                                        ...
                                                        <div style="margin-left: 10px">
                                                            <a href="{{ route('helpdesk.ticket.index', array_merge(request()->query(), ['status_id' => 4, 'TicketSelesai' => $tiket_selesai, 'year' => now()->year, 'month' => now()->format('m')])) }}"
