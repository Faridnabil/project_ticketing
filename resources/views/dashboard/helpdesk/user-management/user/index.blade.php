                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        @can('Create User')
                            <div class="card-toolbar">
                                <!--begin::Add user-->
                                <a href="{{ route('helpdesk.user.create') }}" class="btn btn-primary mb-4">
                                ...
                                @if ($users->count())
                                    @foreach ($users as $user)
                                        ...
                                        <tr class="fs-6 w-100">
                                            ...
                                            <td>
                                                @can('Edit User')
                                                    <a class="menu-link ms-3" href="{{ route('helpdesk.user.edit', $user->id) }}"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="{{ route('helpdesk.user.destroy', $user->id) }}" method="POST" class="d-inline">
                            @method('delete')
                            @csrf
