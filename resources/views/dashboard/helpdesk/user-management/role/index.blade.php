                ...
                <div class="card">
                    ...
                    <div class="card-header border-0 pt-6">
                        ...
                        <div class="card-toolbar">
                            <!--begin::Add user-->
                            <a href="{{ route('helpdesk.role.create') }}" class="btn btn-primary mb-4">
                                ...
                                @if ($roles->count())
                                    @foreach ($roles as $role)
                                        <tr>
                                            ...
                                            <td>
                                                @can('Edit Role')
                                                    <a class="menu-link ms-3" href="{{ route('helpdesk.role.edit', $role->id) }}"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <div class="modal-footer">
                        ...
                        <form action="{{ route('helpdesk.role.destroy', $role->id) }}" method="POST" class="d-inline">
                            @method('delete')
                            @csrf
