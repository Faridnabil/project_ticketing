                        ...
                        <table id="kt_datatable_example_5"
                            ...
                            <thead>
                                ...
                                <tr class="text-start text-black-400 fw-bolder fs-7 text-uppercase gs-0">
                                    ...
                                    <th class="min-w-10px">Peran</th>
                                    <th class="min-w-10">Tanggal Dibuat</th>
                                            ...
                                            <td>
                                                @can('Edit Permission')
                                                    <a class="menu-link ms-3"
                                                        href="{{ route('permission.edit', $permission->id) }}" type="button"
                                                        title="Edit">
                                                ...
                                                @can('Delete Permission')
                                                    <a class="menu-link ms-3" href="#" type="reset"
                                                        ...
                                                        data-bs-target="#kt_modal_1{{ $permission->id }}" title="Hapus">
