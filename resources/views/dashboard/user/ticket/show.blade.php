                                                                ...
                                                                <div class="ms-9 mb-9">
                                                                    <div class="card card-bordered w-100">
                                                                        <div class="card-body">
                                                                            ...
                                                                            @if ($comment->status_comment == 'Dirubah')
                                                                                <textarea name="message" class="form-control @error('message') is-invalid @enderror" id="messageEdit" cols="10"
                                                                                ...
                                                                                <button class="btn btn-primary mt-2"
                                                                                    type="submit">Ubah Komentar</button>
                                                                            ...
                                                                            @else
                                                                                ...
                                                                                <textarea name="message" class="form-control" style="display: none">{{ $comment->message }}</textarea>
                                                                                <input type="hidden" name="status_comment"
                                                                                    value="Dirubah">
                                                                            @endif
                                                                        </div>
