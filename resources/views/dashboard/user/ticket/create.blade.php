                ...
                <div class="col-xl-12">
                    ...
                    <div class="card card-xl-stretch mb-xl-8">
                        ...
                        <div class="card-body pt-5">
                            <form class="row g-3 needs-validation" method="POST" action="{{ route('ticketUser.store') }}"
                                ...
                                <div class="col-md-6">
                                    ...
                                    <select name="customer" class="form-control @error('customer') is-invalid @enderror" required autofocus>
                                        <option value="" selected disabled>Pilih Data anda</option>
                                ...
                                <div class="col-12">
                                    ...
                                    <a href="{{ route('ticketUser.index') }}" class="btn btn-danger">Cancel</a>
                                </div>
                            </form>
                            <!--end form-->
                        </div>
