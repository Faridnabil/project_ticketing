    ...
    <main class="main" id="top">
        <div class="content">
            <nav class="navbar navbar-expand-md fixed-top" id="navbar"
                ...
                <div class="container-fluid px-0"><a href="/"><img class="img-fluid"
                            src="img/logos/logo-petir.png" alt="logo" /></a><a
                        class="navbar-brand fw-bold d-none d-md-block" href="/"></a><a
                        class="btn btn-primary btn-sm ms-md-x1 mt-lg-0 order-md-1 ms-auto " style="background-color: #14a2b1; border-color:#14a2b1" href="{{ route('login') }}">Login Now
            ...
            <div data-bs-target="#navbar" data-bs-spy="scroll" tabindex="0">
                            ...
                            <div class="row gy-4 gy-md-8 pt-9 pt-lg-0">
                                <div class="col-lg-6 text-center text-lg-start">
                                    <h1 class="fs-2 fs-lg-1 text-white fw-bold mb-2 mb-lg-x1 lh-base mt-3 mt-lg-0">
                                        Ticketing System</h1>
                                    <p class="fs-8 text-white mb-3 mb-lg-4 lh-lg">membantu menangani permintaan layanan dengan lebih teratur dan efektif.</p>
                                    <div class="d-flex justify-content-center justify-content-lg-start"><a
                                            class="btn btn-primary btn-lg lh-xl mb-4 mb-md-5 mb-lg-7" style="background-color: #14a2b1; border-color:#14a2b1"
                                            href="#!">Pelajari Lebih Lanjut</a></div>
                                    ...
                                    <div
                                        ...
                                        <a class="border-0 p-0 bg-transparent cursor-pointer rounded-1"
                                            href="#!"> <img class="img-fluid" src="img/logos/App_Store.webp"
                                                alt="img/logos/App_Store.webp" /></a><a
                                            class="border-0 p-0 bg-transparent cursor-pointer rounded-1"
                                            href="#!"> <img class="img-fluid" src="img/logos/Play_Store.webp"
                                                alt="img/logos/Play_Store.webp" /></a>
                                    </div> --}}
                                </div>
                                <div class="col-lg-6 position-lg-relative">
                                    <div class="position-lg-absolute z-1 mt-5 text-right" style="right: 0%"><img
                                            class="img-fluid" src="img/logos/logos.png" alt="" height="400" width="400"/>
                        ...
                        <div class="col-12 col-lg-6 col-xl-5">
                            <div class="row justify-content-center justify-content-lg-start">
                                <div class="col-sm-10 col-md-8 col-lg-12">
                                    <h2 class="fs-4 fs-lg-3 fw-bold mb-2 text-center text-lg-start">Kolaborasi penuh dengan anggota team</h2>
                                    <p class="fs-8 mb-4 mb-lg-5 lh-lg text-center text-lg-start fw-normal">Berkolaborasi dalam satu platform. Menyelesaikan issue dengan cepat.</p>
                                </div>
                                <div class="col-12">
                                    {{-- <div>
                ...
                <section class="container mb-8 mb-lg-11">
                    <div class="row justify-content-center">
                        <div class="col-md-8 col-lg-7">
                            ...
                            {{--  <p class="fs-8 mb-7 mb-lg-8 text-center lh-lg">You can use this as it is or tweak it as you
                                seem necessary. you seem necessary.</p>  --}}
                        </div>
                        <div class="col-12">
                            <div class="row g-sm-2 g-lg-3 align-items-center timeline">
                                ...
                                <div
                                    ...
                                    <div class="py-1 py-lg-0 px-lg-5 w-75 w-sm-50 w-lg-100 timeline-content">
                                        ...
                                        <p class="text-lg-center lh-xl mb-0">Start with adding team members to <span
                                                class="text-nowrap">your channels. </span></p>
                                    </div>
                                </div>
                                <div
                                    class="col-12 col-lg-4 d-flex flex-row flex-lg-column justify-content-center gap-2 gap-sm-x1 gap-md-4 gap-lg-0">
                                    ...
                                    <div class="py-1 py-lg-0 px-lg-5 w-75 w-sm-50 w-lg-100 timeline-content">
                                        ...
                                        <p class="text-lg-center lh-xl mb-0">Start operating your business in a simpler
                                            way <span class="text-nowrap">and grow!</span></p>
                                    </div>
                                </div>
                            </div>
                        </div>
                            ...
                            <div class="col-12">
                                <div class="position-relative z-1 text-center mb-8 mb-lg-9 video-player-paused"
                                    data-video-player-container="data-video-player-container"><video
                                        class="w-100 h-100 rounded-4" src="video/Tech_video.mp4"
                        ...
                        <div class="row justify-content-center">
                            <div class="col-md-8 col-lg-7">
                                <h2
                                    ...
                                    <span class="underline"> 1,749 remote teams </span>have shared their experience
                                    with our app!
                                </h2>
                            </div>
                                                    ...
                                                    <div class="d-flex justify-content-center gap-2">
                                                        <div
                                                            ...
                                                            <div class="text-center text-lg-start"><img
                                                                    ...
                                                                    src="img/feedback/reviewer_1.webp"
                                                                    alt="" /></div>
                                                            <div class="text-center text-lg-start">
                                                                <p class="fs-8 mb-2 lh-lg line-clamp-3 text-1100">“OMG!
                                                ...
                                                <div class="col-12 swiper-slide">
                                                    <div class="d-flex justify-content-center gap-2">
                                                        <div
                                                            ...
                                                            <div class="text-center text-lg-start"><img
                                                                    class="card-image rounded-circle object-fit-cover"
                                                                    src="img/feedback/reviewer_2.webp"
                                                                    alt="" /></div>
                                                            <div class="text-center text-lg-start">
                                                ...
                                                <div class="col-12 swiper-slide">
                                                    <div class="d-flex justify-content-center gap-2">
                                                        <div
                                                            ...
                                                            <div class="text-center text-lg-start"><img
                                                                    class="card-image rounded-circle object-fit-cover"
                                                                    src="img/feedback/reviewer_3.webp"
                                                                    alt="" /></div>
                                                            <div class="text-center text-lg-start">
                                                                <p class="fs-8 mb-2 lh-lg line-clamp-3 text-1100">“Must
                                                                    have book for all, who want to be Product Designer
                                                                    or Interaction Designer.”</p>
                                                ...
                                                <div class="col-12 swiper-slide">
                                                    <div class="d-flex justify-content-center gap-2">
                                                        <div
                                                            ...
                                                            <div class="text-center text-lg-start">
                                                                <p class="fs-8 mb-2 lh-lg line-clamp-3 text-1100">
                                                                    “Every day, I eat, sleep, and worry about stupid
                                                                    things. My job is to ensure that these kids have as
                                                                    many days as possible where they can be idiots like
                                                                    this.”</p>
                                                ...
                                                <div class="col-12 swiper-slide">
                                                    <div class="d-flex justify-content-center gap-2">
                                                        <div
                                                            ...
                                                            <div class="text-center text-lg-start">
                                                                <p class="fs-8 mb-2 lh-lg line-clamp-3 text-1100">“Life
                                                                    isn’t permanent or predictable. You never know when
                                                                    you will run out of time. The best thing you can do
                                                                    is to be honest with those around you and let them
                                                                    know how you really feel. You never know if you have
                                                                    a tomorrow to come.”</p>
                            ...
                            <div class="text-center"><a class="py-1 link-success" href="#!"><span>Read more
                                        reviews </span><span class="uil uil-arrow-right icon"></span></a></div>
                        </div>
                    </div>
                </section>
                    ...
                    <div class="container py-8 py-lg-10">
                        <div class="row justify-content-center">
                            <div class="col-md-8 col-lg-7">
                                ...
                                <p class="fs-8 mb-7 mb-lg-8 text-center lh-lg fw-normal">Show your pricing to your
                                    customers once they’re here with easily modifiable pricing cards. </p>
                            </div>
                            <div class="col-12">
                                <div
                                    ...
                                    <div
                                        ...
                                        <h2 class="mb-3"><span class="fs-6 fs-md-7 fw-bold">$</span><span
                                                class="fs-2 fs-md-1 fw-bold">19</span><span
                                                class="fs-9 lh-xl font-sans-serif">/ mo</span></h2>
                                        <ul class="list-unstyled fs-8 lh-xl fw-light text-1100 ls-1">
                                            ...
                                            <li class="mt-1 d-grid"> <button
                                                    class="btn btn-secondary btn-lg lh-xl">Get Started Now</button>
                                            </li>
                                        </ul>
                                    </div>
                                    <div class="p-x1 text-center bg-white border shadow-sm rounded-2 pricing-card">
                                        ...
                                        <h2 class="mb-3"><span class="fs-6 fs-md-7 fw-bold">$</span><span
                                                class="fs-2 fs-md-1 fw-bold">99</span><span
                                                class="fs-9 lh-xl font-sans-serif">/ mo</span></h2>
                                        <ul class="list-unstyled fs-8 lh-xl fw-light text-1100 ls-1">
                                            ...
                                            <li class="py-x1 px-1 border-top"> Unlimited Meetings </li>
                                            <li class="py-x1 px-1 border-top"> Premium Support </li>
                                            <li class="mt-1 d-grid"> <button class="btn btn-primary btn-lg lh-xl">Get
                                                    Started Now</button></li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
                                ...
                                <div class="row justify-content-center justify-content-lg-start">
                                    <div class="col-md-8 col-lg-12 col-xl-11">
                                        ...
                                        <p
                                            ...
                                            We share common trends and strategies for creating & improving your
                                            text-nowrap rental income.</p>
                                    </div>
                                    <div class="col-lg-10">
                                        <div class="d-flex gap-2 gap-lg-x1 mb-4 mb-lg-5">
                                            ...
                                            <div>
                                                <h5 class="fs-8 fw-bold lh-lg mb-1 text-white">Noise Free Locations
                                                </h5>
                                                <p class="lh-xl text-white text-opacity-70 mb-0">We ensure noise-free
                                                    locations for your peace of mind and sound sleep.</p>
                                            </div>
                                        </div>
                                        <div class="d-flex gap-2 gap-lg-x1 mb-4 mb-lg-5">
                                            <div>
                                            ...
                                            <div>
                                                ...
                                                <p class="lh-xl text-white text-opacity-70 mb-0">Get support from our
                                                    efficient customer support team, 24/7, all year round.</p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div class="accordion-collapse collapse show" id="collapse1"
                                            ...
                                            <div class="accordion-body lh-xl pt-0 pb-x1">Enjoy the easy setup process
                                                with little to no coding knowledge with us!</div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div class="accordion-collapse collapse" id="collapse3"
                                            ...
                                            <div class="accordion-body lh-xl pt-0 pb-x1">We will keep updating the
                                                theme; stay with us to get updated!</div>
                                        </div>
                                    </div>
                                    <div class="accordion-item">
                                    ...
                                    <div class="accordion-item">
                                        ...
                                        <div class="accordion-collapse collapse" id="collapse5"
                                            ...
                                            <div class="accordion-body lh-xl pt-0 pb-x1">To reach our support team,
                                                simply send an email to support@TicketingSystem.com. Our team will
                                                promptly
                                                address your inquiry and provide assistance as needed.</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="col-md-6 col-lg-6">
                                <div class="row ">
                                    <div class="col-12 col-lg-10">
                                        ...
                                        <p class="fs-8 mb-5 mb-lg-5  lh-lg fw-normal"> Hubungi kami untuk informasi lebih lanjut</p>
                                    </div>
                                        ...
                                        <form method="POST" onsubmit="return false;">
                                            ...
                                            <div style="display: flex; align-items: center;">
                                                <img src="/img/icons/envelopes.png" alt="Phone Icon"
                                                    style="width: 16px; height: 16px; margin-right: 8px; margin-bottom:10px">
                                                <p style="font-weight: bold; font-size: 16px; margin: 0;">Email Address
                                                </p>
                                            </div>
                                            <div class="mb-2 w-100"
                                                style="margin-left: 25px;>
                                                <p><i class="fas
                                                fa-envelope"></i>humas@iconpln.co.id</p>
                                            </div>

                                        </form>
                                    </div>
                                    <div class="col-10 col-lg-7">
                                        <p class=" lh-lg mb-0">Kami tidak pernah membagikan rincian Anda kepada pihak ketiga. Lihat Kebijakan Privasi kami untuk informasi lebih lanjut.</p>
                                    </div>
                                </div>
                            </div>
                            <div class="col-md-6 col-lg-6">
                ...
                class="btn scroll-to-top text-white rounded-circle d-flex justify-content-center align-items-center" style="background-color: #125d72	; border-color:#14a2b1"
                    ...
                    <div class="row gy-2 py-3 justify-content-center justify-content-md-between">
                        <div class="col-auto ps-0">
                            <p class="text-center text-md-start lh-xl text-1100"> © 2024 Copyright, All Right Reserved,
                                Made by <a class="fw-semi-bold" href="#"> Anonymous</a>❤️
                            </p>
                        </div>
