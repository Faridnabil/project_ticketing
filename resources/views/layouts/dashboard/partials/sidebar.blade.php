        ...
        <div class="menu menu-column menu-title-gray-800 menu-state-title-primary menu-state-icon-primary menu-state-bullet-primary menu-arrow-gray-500"
            ...
            @can('View Ticket')
                ...
                @role('Helpdesk')
                    ...
                    @can('View Attendance')
                        <div class="dashboard-link-container">
                            <a href="{{ route('helpdesk.monitoring.index') }}"
                                class="dashboard-link {{ request()->routeIs('helpdesk.monitoring.index') ? 'active' : '' }}">
                                <span class="menu-icon">
                                    <!--begin::Svg Icon | path: icons/duotone/Interface/Doughnut.svg-->
                                    <span class="svg-icon svg-icon-2">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px"
                                ...
                                <span style="margin-left: 10px">Monitoring Tiket</span>
                            </a>
                        </div>
                    @endcan
                @endrole
            ...
            @hasrole(['Helpdesk', 'Admin'])
                <div class="dashboard-link-container">
                    <a href="{{ route('helpdesk.solution.index') }}"
                        class="dashboard-link {{ request()->routeIs('helpdesk.solution.index') ? 'active' : '' }}">
                        <span class="menu-icon">
                            <!--begin::Svg Icon | path: icons/duotone/Design/PenAndRuller.svg-->
                            <span class="svg-icon svg-icon-2">
                                <svg xmlns="http://www.w3.org/2000/svg" width="24px" height="24px"
